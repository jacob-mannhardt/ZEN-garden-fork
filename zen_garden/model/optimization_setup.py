...
class OptimizationSetup(object):
    ...
    def initialize_component(self, calling_class, component_name, index_names=None, set_time_steps=None, capacity_types=False):
        ...
        if calling_class == EnergySystem:
            ...
            component_data, dict_of_units, attribute_is_series = self.get_attribute_of_all_elements(calling_class, component_name,index_names=index_names, capacity_types=capacity_types, return_attribute_is_series=True)
